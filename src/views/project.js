...
export function Project(slug) {
  ...
  const [s, title, a, b, date, timeline, role, , img, deliverables, platform, , , mock, hero] = projects[i];
  ...
  <div class="case-media"><img src="${heroSrc}" alt="${title}" loading="lazy" decoding="async" /></div></div>
