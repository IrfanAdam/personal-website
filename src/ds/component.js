/* ADAM/DS — ds/component · composer · [plan:2026-09-24_170000-code-syntax-highlight.md#phase-2] */
...
export function component(o) {
  ...
  const codeHTML = ['<div class="ds-code" data-lang="html" data-comp-code="', id, '"><pre><code class="hl">',
    highlight(o.code(init)),
    '</code></pre></div><div class="fx-btns"><button class="pill" data-comp-copy="', id, '">copy code</button></div>',
  ...
  const specHTML = [
    o.anatomy ? '<p class="sub" style="margin-top:var(--space-12)"><span class="tok">What</span> '
      + o.anatomy + '</p>' : '',
...
export function mountComponent(root) {
  ...
  root.querySelectorAll('[data-comp-root]').forEach((sec) => {
    ...
    const codeEl = sec.querySelector('[data-comp-code="' + id + '"] code.hl');
