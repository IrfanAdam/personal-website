...
<div class="ds-sec"><h2>Viewer (cyberpunk expander)</h2><p class="sub">Hover-only portal preview, <span class="tok">180px</span> wide. Cursor becomes a <span class="tok">32px</span> viewfinder; preview floats outside the card (flips right → left on collision), Y follows with a clamped spring, two tether lines join them. Grid + scan overlays reuse <span class="tok">--shimmer-band</span> sheen. Off on touch, mobile, and reduced-motion.</p>
<div class="ds-spec block"><div class="viewer on" style="position:relative;inset:auto;opacity:1;animation:none"><div class="viewer-shimmer"></div><img src="/images/fluxx.jpg" alt=""/></div></div></div>
