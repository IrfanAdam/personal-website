...
export function render(){
  return [
    `<p class="ds-crumb">Functions · Shimmer</p><div class="ds-hero"><h1>Skeletal shimmer.</h1>`,
...
+[
  ...
  `<p class="sub">Grid is <span class="tok">--reveal-grid</span> (reads <span class="tok">--fx-grid-pitch</span>); `,
  `sheen is a masked gradient sweep.</p>`,
].join('')
...
+[
  `<figure><figcaption>grid = --reveal-grid · sheen = masked gradient sweep · reduced-motion: off</figcaption>`,
  `</figure></div>`,
].join('')
+[
...
+[
  ...
  `<td>shimmer 2.2s</td><td><span class="tok">--dur-shimmer</span></td></tr></table></div>`,
].join('');
}
