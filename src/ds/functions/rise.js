...
+[
  ...
  `<p class="sub">Placeholder <span class="tok">--space-90</span> → final <span class="tok">--size-ds-img</span>; `,
  `replay re-runs the rise.</p>`,
].join('')
...
+[
  ...
  `<td>range stays literal (viewport math)</td></tr></table></div>`,
].join('');
}
