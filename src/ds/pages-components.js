...
<div class="ds-sec"><h2>Viewer portal</h2><p class="sub">Fixed-position expander: <span class="tok">.viewer-cursor</span> viewfinder, <span class="tok">.viewer</span> portal (grid + scan + shimmer), <span class="tok">.viewer-lines</span> twin tethers. Neon rim via <span class="tok">--viewer-neon</span>; zero radius throughout.</p>
