...
const contactTokens=['--size-input-h',
  '--color-input-bg',
  '--color-input-line',
  '--color-input-focus',
  '--color-accent',
...
export function render(){const h=playground({title:'Header',
      ...
      code:headerCode,
      tokens:headerTokens});
  const f=playground({title:'Footer',
      ...
      code:footerCode,
      tokens:footerTokens});
  const he=playground({title:'Hero',
  ...
  const c=playground({title:'Card',
      ...
      code:cardCode,
      tokens:cardTokens});
  const w=playground({title:'Work row',
      ...
      code:workCode,
      tokens:workTokens});
  const fi=playground({title:'Filters',
  ...
  const st=playground({title:'Strip tabs',
      ...
      code:stripCode,
      tokens:stripTokens});
  const sp=playground({title:'Spec list',
      ...
      code:specCode,
      tokens:specTokens});
  const nx=playground({title:'Next card',
      ...
      code:nextCode,
      tokens:nextTokens});
  const ct=playground({title:'CTA band',
      ...
      code:ctaCode,
      tokens:ctaTokens});
  const co=playground({title:'Contact composition',
