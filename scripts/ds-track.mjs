...
/* Two DS files are build-generated, never authored: the manifest rewrites
   itself at every ds-track run and arch-schema.json is regenerated by
   map-graph in build/predev — listing either as wip is phantom noise that
   shows up as "Uncommitted:" on every deployed changelog. */
